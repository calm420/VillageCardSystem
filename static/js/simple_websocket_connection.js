function SimpleConnection() {
    ...
    this.LOCAL_URL = "ws://"+WebServiceUtil.localDomain+":8891/Excoord_SimpleWsServer/simple";
    this.WS_URL = WebServiceUtil.isDebug_simpleScoket ? this.LOCAL_URL : this.REMOTE_URL;
    this.ws = null;

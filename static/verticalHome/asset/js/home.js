...
$(document).ready(function () {
    ...
    function InitializePage() {
        ...
        $("#studentOnDuty")[0].src = webserviceUrl + "studentOnDuty?clazzId=" + clazzId + "&roomId=" + roomId + "&mac=" + mac + "&schoolId=" + schoolId + "&font=" + $('html').css('font-size')+"&screenWidth="+window.screen.width+"&screenHeight="+window.screen.height;
        ...
        $("#header")[0].src = webserviceUrl + "header?clazzId=" + clazzId + "&roomId=" + roomId + "&mac=" + mac + "&schoolId=" + schoolId + "&v=0.0.1"+ "&font=" + $('html').css('font-size')+"&screenWidth="+window.screen.width+"&screenHeight="+window.screen.height;
        setTimeout(function () {
            ms.connect(pro);
            msListener();
            simpleListener();

                ...
                if (result.success == true && result.msg == "调用成功") {
                    ...
                    if (response != null && response != undefined) {
                        if (response.length === 0) {
                            var emptyDiv = '<div class=\'empty_center\'><div class=\'empty_icon empty_honor\'></div><div class=\'empty_text\'>暂无荣誉</div></div>';
        ...
        WebServiceUtil.requestLittleAntApi(true, JSON.stringify(param), {
            onResponse: function (result) {
                if (result.success == true && result.msg == "调用成功") {
                    ...
                    if (response != null && response != undefined) {
                        if (response.length === 0) {
                            var emptyDiv = '<div class=\'empty_center\'><div class=\'empty_icon empty_honor\'></div><div class=\'empty_text\'>暂无班级风采</div></div>';
